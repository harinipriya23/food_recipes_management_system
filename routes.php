...
/* -------- USERS -------- */
$router->get('/food_recipes/dashboard', '/users/dashboard/index.php')->only('user');
$router->get('/food_recipes/user/recipes', '/users/recipes/overview.php');
...
$router->get('/food_recipes/recipe', '/users/recipes/form.php')->only('user');
$router->get('/food_recipes/report', '/users/report/report.php')->only('user');

/* -------- AJAX routes -------- */
$router->post('/food_recipes/recipe/add-ingredient', '/users/recipes/add.php')->only('user');
$router->post('/food_recipes/recipe/add-new-recipe', '/users/recipes/store.php')->only('user');
$router->post('/food_recipes/recipe/update-recipe', '/users/recipes/update.php')->only('user');

/* -------- ADMIN -------- */
$router->get('/food_recipes/admin/dashboard', '/admin/dashboard/index.php')->only('admin');
...
$router->get('/food_recipes/admin/report', '/admin/report/recipe_report.php')->only('admin');
$router->get('/food_recipes/admin/report-comments', '/admin/report/comment_report.php')->only('admin');

$router->get('/food_recipes/admin/contact', '/admin/contact/contact.php')->only('admin');
$router->post('/food_recipes/admin/contact', '/admin/contact/save.php')->only('admin');
...
$router->post('/food_recipes/admin/about', '/admin/about/save.php')->only('admin');
